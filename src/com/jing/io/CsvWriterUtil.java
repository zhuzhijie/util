...
public class CsvWriterUtil {
	 ...
	 *            The character to use as the column delimiter.
	 */
	public CsvWriterUtil(Writer outputStream, char delimiter) {
	 ...
	 *            writing the data.
	 */
	public CsvWriterUtil(OutputStream outputStream, char delimiter, Charset charset) {
